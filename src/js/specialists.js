document.addEventListener("DOMContentLoaded", () => {
	const slider = document.querySelector('.specialists__container');
	const list = document.querySelector('.specialists__list');
	const btnPrev = document.querySelector('.specialists__btn-next');
	const btnNext = document.querySelector('.specialists__btn-prev');
